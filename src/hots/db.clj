...
(def heroes-map
  {:Anton       #{"Artanis" "Butcher" "Cho" "E.T.C." "Gall" "Gazlowe" "Jaina" "Kerrigan" "Kharazim" "Leoric" "Li Li"
                  ...
                  "Valla"}
   :Bratus      #{"Anub'arak" "Brightwing" "Cho" "E.T.C." "Gall" "Gazlowe" "Jaina" "Kharazim"
                  "Li Li" "Li-Ming" "Lt. Morales" "Lunara" "Malfurion" "Muradin" "Raynor" "Rehgar" "Sgt. Hammer"
   ...
   :Konstantine #{"Anub'arak" "Artanis" "Arthas" "Azmodan" "Butcher" "Cho" "Diablo" "E.T.C." "Gall" "Gazlowe" "Greymane"
